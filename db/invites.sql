...
-- 3. The gate: reject disallowed signups before the user row is committed. ----
...
create trigger enforce_registration_policy
  before insert on auth.users
  for each row execute function public.enforce_registration_policy();
